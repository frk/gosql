...
func (q *InsertWithReturningSliceErrorInfoHandlerQuery) Exec(c gosql.Conn) error {
	...
	if err != nil {
		return q.erh.HandleErrorInfo(&gosql.ErrorInfo{Error: err, Query: queryString, SpecKind: "Insert", SpecName: "InsertWithReturningSliceErrorInfoHandlerQuery", SpecValue: q})
	}
	defer rows.Close()
