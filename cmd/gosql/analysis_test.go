...
func TestAnalysis_queryStruct(t *testing.T) {
	...
	tests := []struct {
		...
		err: analysisError{
			...
			structName:  "InsertAnalysisTestBAD_NoDataField",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD3",
			blockName:   "",
			fieldType:   "string",
			fieldName:   "User",
			tagValue:    "",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "DeleteAnalysisTestBAD_BadRelId",
			blockName:   "",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_MultipleRelTags",
			blockName:   "",
			fieldType:   "path/to/test.T",
			fieldName:   "Rel2",
			tagValue:    "",
		...
		err: analysisError{
			...
			fieldType:   "int",
			fieldName:   "Count",
			structName:  "DeleteAnalysisTestBAD_IllegalCountField",
			packagePath: "path/to/test",
			fileLine:    33,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldType:   "bool",
			fieldName:   "Exists",
			structName:  "UpdateAnalysisTestBAD_IllegalExistsField",
			packagePath: "path/to/test",
			fileLine:    38,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldType:   "bool",
			fieldName:   "NotExists",
			structName:  "InsertAnalysisTestBAD_IllegalNotExistsField",
			packagePath: "path/to/test",
			fileLine:    43,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "_",
			structName:  "SelectAnalysisTestBAD_IllegalRelationDirective",
			packagePath: "path/to/test",
			fileLine:    48,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			errorCode:   errDataType,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_UnnamedBaseStructType",
			fieldType:   "[]*struct{}",
			fieldName:   "Rel",
			fileName:    "../../testdata/analysis_bad.go",
			fileLine:    53,
		...
		err: analysisError{
			...
			fieldName:   "_",
			structName:  "SelectAnalysisTestBAD_IllegalAllDirective",
			packagePath: "path/to/test",
			fileLine:    59,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldType:   "github.com/frk/gosql.All",
			fieldName:   "_",
			structName:  "InsertAnalysisTestBAD_IllegalAllDirective",
			packagePath: "path/to/test",
			fileLine:    65,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "UpdateAnalysisTestBAD_ConflictWhereProducer",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.All",
			fieldName:   "_",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			...
			fieldName:   "_",
			structName:  "DeleteAnalysisTestBAD_IllegalDefaultDirective",
			packagePath: "path/to/test",
			fileLine:    80,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldType:   "github.com/frk/gosql.Default",
			fieldName:   "_",
			structName:  "UpdateAnalysisTestBAD_EmptyDefaultDirectiveCollist",
			packagePath: "path/to/test",
			fileLine:    86,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "_",
			structName:  "SelectAnalysisTestBAD_IllegalForceDirective",
			packagePath: "path/to/test",
			fileLine:    92,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "UpdateAnalysisTestBAD_BadForceDirectiveColId",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Force",
			fieldName:   "_",
			tagValue:    "1234",
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "DeleteAnalysisTestBAD_ConflictResultProducer",
			blockName:   "",
		...
		err: analysisError{
			...
			fieldType:   "github.com/frk/gosql.Return",
			fieldName:   "_",
			structName:  "UpdateAnalysisTestBAD_EmptyReturnDirectiveCollist",
			packagePath: "path/to/test",
			fileLine:    117,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "_",
			structName:  "InsertAnalysisTestBAD_IllegalLimitField",
			packagePath: "path/to/test",
			fileLine:    123,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "_",
			structName:  "UpdateAnalysisTestBAD_IllegalOffsetField",
			packagePath: "path/to/test",
			fileLine:    129,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "_",
			structName:  "InsertAnalysisTestBAD_IllegalOrderByDirective",
			packagePath: "path/to/test",
			fileLine:    135,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "_",
			structName:  "DeleteAnalysisTestBAD_IllegalOverrideDirective",
			packagePath: "path/to/test",
			fileLine:    141,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "_",
			structName:  "SelectAnalysisTestBAD_IllegalTextSearchDirective",
			packagePath: "path/to/test",
			fileLine:    147,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "_",
			structName:  "SelectAnalysisTestBAD_IllegalColumnDirective",
			packagePath: "path/to/test",
			fileLine:    153,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "Where",
			structName:  "InsertAnalysisTestBAD_IllegalWhereBlock",
			packagePath: "path/to/test",
			fileLine:    159,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "Join",
			structName:  "UpdateAnalysisTestBAD_IllegalJoinBlock",
			packagePath: "path/to/test",
			fileLine:    167,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldType:   "struct{_ github.com/frk/gosql.Relation}",
			fieldName:   "From",
			structName:  "DeleteAnalysisTestBAD_IllegalFromBlock",
			packagePath: "path/to/test",
			fileLine:    175,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldType:   "struct{_ github.com/frk/gosql.Relation}",
			fieldName:   "Using",
			structName:  "SelectAnalysisTestBAD_IllegalUsingBlock",
			packagePath: "path/to/test",
			fileLine:    183,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			structName:  "UpdateAnalysisTestBAD_IllegalOnConflictBlock",
			packagePath: "path/to/test",
			fileLine:    191,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldType:   "path/to/test.T",
			fieldName:   "Result",
			structName:  "SelectAnalysisTestBAD_IllegalResultField",
			packagePath: "path/to/test",
			fileLine:    199,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_ConflictLimitProducer",
			blockName:   "",
			fieldType:   "int",
			fieldName:   "Limit",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_ConflictOffsetProducer",
			blockName:   "",
			fieldType:   "int",
			fieldName:   "Offset",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			...
			structName:  "SelectAnalysisTestBAD_IllegalRowsAffectedField",
			packagePath: "path/to/test",
			fileLine:    219,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldName:   "F",
			structName:  "InsertAnalysisTestBAD_IllegalFilterField",
			packagePath: "path/to/test",
			fileLine:    225,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_ConflictWhereProducer",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Filter",
			fieldName:   "F",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "DeleteAnalysisTestBAD_ConflictWhereProducer",
			blockName:   "",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_IteratorWithTooManyMethods",
		...
		err: analysisError{
			errorCode:   errIterType,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_IteratorWithBadSignature",
		...
		err: analysisError{
			errorCode:   errIterType,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_IteratorWithBadSignatureIface",
		...
		err: analysisError{
			errorCode:   errIterType,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_IteratorWithUnexportedMethod",
		...
		err: analysisError{
			errorCode:   errIterType,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_IteratorWithUnnamedArgument",
		...
		err: analysisError{
			errorCode:   errIterType,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_IteratorWithNonStructArgument",
		...
		err: analysisError{
			errorCode:   errDataType,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_BadRelfiedlStructBaseType",
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "UpdateAnalysisTestBAD_BadRelTypeFieldColId",
			blockName:   "",
			fieldType:   "string",
			fieldName:   "Foo",
			tagValue:    "1234",
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "UpdateAnalysisTestBAD_ConflictWhereProducer2",
			blockName:   "",
			fieldType:   "struct{Id int \"sql:\\\"id\\\"\"}",
			fieldName:   "Where",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "DeleteAnalysisTestBAD_BadWhereBlockType",
			blockName:   "",
			fieldType:   "[]string",
			fieldName:   "Where",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadBoolTagValue",
			blockName:   "Where",
			fieldType:   "string",
			fieldName:   "Name",
			tagValue:    "abc",
		...
		err: analysisError{
			errorCode:   errFieldBlock,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadNestedWhereBlockType",
			blockName:   "Where",
			fieldType:   "path/to/test.notstruct",
			fieldName:   "X",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadColumnExpressionLHS",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Column",
			fieldName:   "_",
			tagValue:    "123",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadColumnPredicateCombo",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Column",
			fieldName:   "_",
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "DeleteAnalysisTestBAD_BadColumnExpressionLHS",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Column",
			fieldName:   "_",
			tagValue:    "123",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "UpdateAnalysisTestBAD_BadUnaryOp",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Column",
			fieldName:   "_",
			tagValue:    "x <=",
		...
		err: analysisError{
			errorCode:   errIllegalPredicateQuantifier,
			packagePath: "path/to/test",
			structName:  "UpdateAnalysisTestBAD_ExtraQuantifier",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Column",
			fieldName:   "_",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadBetweenFieldType",
			fieldType:   "path/to/test.notstruct",
			fieldName:   "between",
			fileName:    "../../testdata/analysis_bad.go",
			fileLine:    374,
		...
		err: analysisError{
			errorCode:   errBadBetweenPredicate,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadBetweenFieldType2",
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadBetweenArgColId",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Column",
			fieldName:   "_",
			tagValue:    "123",
		...
		err: analysisError{
			errorCode:   errBadBetweenPredicate,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_NoBetweenXYArg",
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadBetweenColId",
			blockName:   "",
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "DeleteAnalysisTestBAD_BadWhereFieldColId",
			blockName:   "",
			fieldType:   "int",
			fieldName:   "Id",
			tagValue:    "123",
		...
		err: analysisError{
			errorCode:   errIllegalPredicateQuantifier,
			packagePath: "path/to/test",
			structName:  "DeleteAnalysisTestBAD_BadWhereFieldPredicateCombo",
			fieldType:   "int",
			fieldName:   "Id",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "DeleteAnalysisTestBAD_IllegalWhereFieldUnaryPredicate",
			blockName:   "",
			fieldType:   "int",
			fieldName:   "Id",
		...
		err: analysisError{
			errorCode:   errIllegalPredicateQuantifier,
			packagePath: "path/to/test",
			structName:  "UpdateAnalysisTestBAD_BadWhereFieldTypeForQuantifier",
			fieldType:   "int",
			fieldName:   "Id",
			tagValue:    "a.id = any",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			errorCode:   errFieldBlock,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadJoinBlockType",
			blockName:   "",
			fieldType:   "path/to/test.notstruct",
			fieldName:   "Join",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			...
			fieldType:   "github.com/frk/gosql.Relation",
			fieldName:   "_",
			structName:  "SelectAnalysisTestBAD_IllegalJoinBlockRelationDirective",
			packagePath: "path/to/test",
			fileLine:    463,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "DeleteAnalysisTestBAD_ConflictRelationDirective",
			fieldType:   "github.com/frk/gosql.Relation",
			fieldName:   "_",
			fileName:    "../../testdata/analysis_bad.go",
			fileLine:    472,
		...
		err: analysisError{
			errorCode:   errBadRelIdTagValue,
			packagePath: "path/to/test",
			structName:  "UpdateAnalysisTestBAD_BadFromRelationRelId",
			fieldType:   "github.com/frk/gosql.Relation",
			fieldName:   "_",
			tagValue:    "123",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			errorCode:   errBadRelIdTagValue,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadJoinDirectiveRelId",
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadJoinDirectiveExpressionColId",
			fieldType:   "github.com/frk/gosql.LeftJoin",
			fieldName:   "_",
			tagValue:    "123",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			errorCode:   errBadUnaryPredicate,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadJoinDirectiveExpressionPredicate",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.LeftJoin",
			fieldName:   "_",
			tagValue:    "b.foo =",
		...
		err: analysisError{
			errorCode:   errIllegalPredicateQuantifier,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadJoinDirectiveExpressionExtraQuantifier",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.LeftJoin",
			fieldName:   "_",
		...
		err: analysisError{
			errorCode:   errIllegalPredicateQuantifier,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadJoinDirectiveExpressionPredicateCombo",
			fieldType:   "github.com/frk/gosql.LeftJoin",
			fieldName:   "_",
		...
		err: analysisError{
			...
			fieldType:   "github.com/frk/gosql.Column",
			fieldName:   "_",
			structName:  "DeleteAnalysisTestBAD_IllegalJoinBlockDirective",
			packagePath: "path/to/test",
			fileLine:    528,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			errorCode:   errFieldBlock,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_BadOnConflictBlockType",
			blockName:   "",
			fieldType:   "path/to/test.notstruct",
			fieldName:   "OnConflict",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_ConflictOnConflictBlockTargetProducer",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Column",
			fieldName:   "_",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_ConflictOnConflictBlockTargetProducer2",
			blockName:   "",
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_ConflictOnConflictBlockTargetProducer3",
			blockName:   "",
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_ConflictOnConflictBlockActionProducer",
			blockName:   "",
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_ConflictOnConflictBlockActionProducer2",
			blockName:   "",
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_BadOnConflictColumnTargetValue",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Column",
			fieldName:   "_",
			tagValue:    "a.1234",
		...
		err: analysisError{
			...
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_BadOnConflictIndexTargetIdent",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Index",
			fieldName:   "_",
			tagValue:    "1234",
		...
		err: analysisError{
			errorCode:   errBadTagValue,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_BadOnConflictConstraintTargetIdent",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Constraint",
			fieldName:   "_",
			tagValue:    "1234",
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_BadOnConflictUpdateActionCollist",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Update",
			fieldName:   "_",
			tagValue:    "a.1234",
		...
		err: analysisError{
			...
			fieldType:   "github.com/frk/gosql.LeftJoin",
			fieldName:   "_",
			structName:  "InsertAnalysisTestBAD_IllegalOnConflictDirective",
			packagePath: "path/to/test",
			fileLine:    622,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			errorCode:   errNoTargetField,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_NoOnConflictTarget",
			blockName:   "",
		...
		err: analysisError{
			...
			fieldType:   "string",
			fieldName:   "Limit",
			structName:  "SelectAnalysisTestBAD_BadLimitFieldType",
			packagePath: "path/to/test",
			fileName:    "../../testdata/analysis_bad.go",
			fileLine:    637,
		},
		...
		err: analysisError{
			...
			fieldType:   "github.com/frk/gosql.Limit",
			fieldName:   "_",
			structName:  "SelectAnalysisTestBAD_NoLimitDirectiveValue",
			packagePath: "path/to/test",
			fileLine:    643,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			errorCode:   errBadTagValue,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadLimitDirectiveValue",
			fieldType:   "github.com/frk/gosql.Limit",
			fieldName:   "_",
			tagValue:    "abc",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			...
			fieldType:   "string",
			fieldName:   "Offset",
			structName:  "SelectAnalysisTestBAD_BadOffsetFieldType",
			packagePath: "path/to/test",
			fileLine:    655,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			...
			fieldType:   "github.com/frk/gosql.Offset",
			fieldName:   "_",
			structName:  "SelectAnalysisTestBAD_NoOffsetDirectiveValue",
			packagePath: "path/to/test",
			fileLine:    661,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			errorCode:   errBadTagValue,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadOffsetDirectiveValue",
			fieldType:   "github.com/frk/gosql.Offset",
			fieldName:   "_",
			tagValue:    "abc",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			...
			fieldType:   "github.com/frk/gosql.OrderBy",
			fieldName:   "_",
			structName:  "SelectAnalysisTestBAD_EmptyOrderByDirectiveCollist",
			packagePath: "path/to/test",
			fileLine:    673,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			errorCode:   errBadTagValue,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadOrderByDirectiveNullsOrderValue",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.OrderBy",
			fieldName:   "_",
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "SelectAnalysisTestBAD_BadOrderByDirectiveCollist",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.OrderBy",
			fieldName:   "_",
			tagValue:    "a.1234",
		...
		err: analysisError{
			errorCode:   errBadTagValue,
			packagePath: "path/to/test",
			structName:  "InsertAnalysisTestBAD_BadOverrideDirectiveKindValue",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.Override",
			fieldName:   "_",
			tagValue:    "foo",
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "UpdateAnalysisTestBAD_ConflictResultProducer",
			blockName:   "",
			fieldType:   "[]path/to/test.T",
			fieldName:   "Result",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			errorCode:   errDataType,
			packagePath: "path/to/test",
			structName:  "UpdateAnalysisTestBAD_BadResultFieldType",
			fieldType:   "[]path/to/test.notstruct",
			fieldName:   "Result",
			fileName:    "../../testdata/analysis_bad.go",
			fileLine:    704,
		...
		err: analysisError{
			errorCode:   errFieldConflict,
			packagePath: "path/to/test",
			structName:  "DeleteAnalysisTestBAD_ConflictResultProducer2",
			blockName:   "",
			fieldType:   "int",
			fieldName:   "RowsAffected",
			fileName:    "../../testdata/analysis_bad.go",
		...
		err: analysisError{
			...
			fieldType:   "string",
			fieldName:   "RowsAffected",
			structName:  "DeleteAnalysisTestBAD_BadRowsAffecteFieldType",
			packagePath: "path/to/test",
			fileLine:    717,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		want: &queryStruct{
			...
			joinBlock: &joinBlock{name: "Using", pos: 24912, relId: relId{name: "relation_b", alias: "b"}, items: []*joinItem{
		...
		want: &queryStruct{
			...
			joinBlock: &joinBlock{name: "From", pos: 25379, relId: relId{name: "relation_b", alias: "b"}, items: []*joinItem{
				{joinType: joinLeft, relId: relId{name: "relation_c", alias: "c"}, conds: []*searchCondition{{
					cond: &searchConditionColumn{
						colId:  colId{qual: "c", name: "b_id"},
						colId2: colId{qual: "b", name: "id"},
		...
		want: &queryStruct{
			...
			joinBlock: &joinBlock{name: "Join", pos: 25845, items: []*joinItem{
...
func TestAnalysis_filterStruct(t *testing.T) {
	...
	tests := []struct {
		...
		err: analysisError{
			...
			fieldType:   "github.com/frk/gosql.Return",
			fieldName:   "_",
			structName:  "FilterAnalysisTestBAD_IllegalReturnDirective",
			packagePath: "path/to/test",
			fileLine:    104,
			fileName:    "../../testdata/analysis_bad.go",
		},
		...
		err: analysisError{
			errorCode:   errBadColIdTagValue,
			packagePath: "path/to/test",
			structName:  "FilterAnalysisTestBAD_BadTextSearchDirectiveColId",
			blockName:   "",
			fieldType:   "github.com/frk/gosql.TextSearch",
			fieldName:   "_",
			tagValue:    "123",
