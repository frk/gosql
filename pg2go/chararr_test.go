...
func TestCharArray(t *testing.T) {
	testlist2{{
		valuer:  CharArrayFromString,
		scanner: CharArrayToString,
		data: []testdata{
			{input: "", output: string(``)},
		...
		valuer:  CharArrayFromByteSlice,
		scanner: CharArrayToByteSlice,
		data: []testdata{
		...
		valuer:  CharArrayFromRuneSlice,
		scanner: CharArrayToRuneSlice,
		data: []testdata{
		...
		valuer:  CharArrayFromStringSlice,
		scanner: CharArrayToStringSlice,
		data: []testdata{
