...
func TestHStore(t *testing.T) {
	...
	testlist{{
		...
		data: []testdata{
			{input: nil, output: new(map[string]string)},
		...
		data: []testdata{
			{input: nil, output: new(map[string]sql.NullString)},
		...
		data: []testdata{
				...
				output: strptr(`"a"=>"1"`)},
			{
				...
				output: strptr(`"a"=>"1", "b"=>"2"`)},
			{
				input:  string(`"text"=>"foo' \"bar\", baz \\quux"`),
				output: strptr(`"text"=>"foo' \"bar\", baz \\quux"`)},
			{
				input:  string(`"a"=>"1", "b"=>NULL,"c"=>NULL`),
				output: strptr(`"a"=>"1", "b"=>NULL, "c"=>NULL`)},
			{
				input:  string(`"a"=>"1", "b"=>"\\\"","c"=>"\\\\\\\\"`),
				output: strptr(`"a"=>"1", "b"=>"\\\"", "c"=>"\\\\\\\\"`)},
		},
	}, {
		valuer: func() interface{} {
			return nil // []byte
		...
		data: []testdata{
				...
				output: bytesptr(`"a"=>"1"`)},
			{
				...
				output: bytesptr(`"a"=>"1", "b"=>"2", "c"=>"3"`)},
			{
				input:  []byte(`"a"=>"1", "b"=>NULL,"c"=>NULL`),
				output: bytesptr(`"a"=>"1", "b"=>NULL, "c"=>NULL`)},
			{
				input:  []byte(`"a"=>"1", "b"=>"\\\"","c"=>"\\\\\\\\"`),
				output: bytesptr(`"a"=>"1", "b"=>"\\\"", "c"=>"\\\\\\\\"`)},
			{
				input:  []byte(`"text"=>"foo' \"bar\", baz \\quux"`),
				output: bytesptr(`"text"=>"foo' \"bar\", baz \\quux"`)},
		},
	}}.execute(t, "hstore")
}
