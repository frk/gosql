...
func TestFloat8(t *testing.T) {
	testlist{{
		...
		data: []testdata{
			...
			{input: float64(3.14), output: f64ptr(3.14)},
			{input: float64(0.15), output: f64ptr(0.15)},
		},
	}, {
		valuer: func() interface{} {
			return nil // string
		...
		data: []testdata{
			...
			{input: string("3.14"), output: strptr(`3.14`)},
			{input: string("0.15"), output: strptr(`0.15`)},
		},
	}, {
		valuer: func() interface{} {
			return nil // []byte
		...
		data: []testdata{
			...
			{input: []byte("3.14"), output: bytesptr(`3.14`)},
			{input: []byte("0.15"), output: bytesptr(`0.15`)},
		},
	}}.execute(t, "float8")
}
