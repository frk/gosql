...
func TestBPCharArray(t *testing.T) {
	testlist{{
		...
		scanner: func() (interface{}, interface{}) {
			s := BPCharArrayToString{Val: new(string)}
			return s, s.Val
		},
		data: []testdata{
			{input: "", output: strptr(``)},
		...
		scanner: func() (interface{}, interface{}) {
			s := BPCharArrayToByteSlice{Val: new([]byte)}
			return s, s.Val
		},
		data: []testdata{
		...
		scanner: func() (interface{}, interface{}) {
			s := BPCharArrayToRuneSlice{Val: new([]rune)}
			return s, s.Val
		},
		data: []testdata{
		...
		scanner: func() (interface{}, interface{}) {
			s := BPCharArrayToStringSlice{Val: new([]string)}
			return s, s.Val
		},
		data: []testdata{
