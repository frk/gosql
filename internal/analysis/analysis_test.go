...
func TestAnalysis_queryStruct(t *testing.T) {
	...
	tests := []struct {
		...
		err: Error{
			Code:       ErrIllegalField,
			BlockName:  "",
			FieldType:  "int",
			FieldName:  "Count",
			TagValue:   `rel:"relation_a:a"`,
		...
		err: Error{
			...
			FieldType:  "github.com/frk/gosql.LeftJoin",
			FieldName:  "_",
			TagValue:   `sql:"relation_b:b,123 = b.foo"`,
			FileName:   "../testdata/analysis_bad.go",
			FileLine:   496,
		},
	}, {
		...
		err: Error{
			...
			FieldType:  "github.com/frk/gosql.LeftJoin",
			FieldName:  "_",
			TagValue:   `sql:"relation_b:b,b.foo ="`,
			FileName:   "../testdata/analysis_bad.go",
			FileLine:   504,
		},
	}, {
		...
		err: Error{
			...
			FieldType:  "github.com/frk/gosql.LeftJoin",
			FieldName:  "_",
			TagValue:   `sql:"relation_b:b,b.foo isnull any"`,
			FileName:   "../testdata/analysis_bad.go",
			FileLine:   512,
		},
	}, {
		...
		err: Error{
			...
			FieldType:  "github.com/frk/gosql.LeftJoin",
			FieldName:  "_",
			TagValue:   `sql:"relation_b:b,b.foo isin any a.bar"`,
			FileName:   "../testdata/analysis_bad.go",
			FileLine:   520,
		},
	}, {
		...
		err: Error{
			...
			FieldType:  "github.com/frk/gosql.LeftJoin",
			FieldName:  "_",
			TagValue:   `sql:"relation_b:b,b.id=a.id"`,
			PkgPath:    "path/to/test",
			FileLine:   622,
			FileName:   "../testdata/analysis_bad.go",
		},
		...
		err: Error{
			...
			FieldType:  "github.com/frk/gosql.OrderBy",
			FieldName:  "_",
			TagValue:   `sql:"-a.id:nullsfirst,a.1234"`,
			FileName:   "../testdata/analysis_bad.go",
			FileLine:   685,
		},
	}, {
